...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-29 09:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3cdbc7bf-2a85-4b56-80be-18d802b06bae.git
$ cd 3cdbc7bf-2a85-4b56-80be-18d802b06bae
```
